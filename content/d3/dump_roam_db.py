...
#
# code reference: https://hugocisneros.com/blog/my-org-roam-notes-workflow/#publishing
#
...
def build_graph() -> nx.DiGraph:
    ...
    conn = sqlite3.connect("/home/pk/program/emacs/config/home/.emacs.d/org-roam.db")
...
if __name__ == "__main__":
    ...
    output_file = os.path.dirname(os.path.abspath(__file__)) + "/connect.json"
